...
class HybridEncoder(nn.Module):
    ...
    @staticmethod
    def _collect_unique_trainable_parameters(modules):
        parameters = []
        seen = set()
    ...
    def get_gam_parameter_groups(self):
        aifi_modules = []
        for encoder_list_index, feature_index in enumerate(self.use_encoder_idx):
            aifi_modules.append(self.input_proj[feature_index])
            aifi_modules.append(self.encoder[encoder_list_index])
        ...
        return {
            "aifi": self._collect_unique_trainable_parameters(aifi_modules),
            "ccff": self._collect_unique_trainable_parameters(ccff_modules),
        }
